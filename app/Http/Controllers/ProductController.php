...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $cData->features = request('features');
        $cData->infos = request('infos');
        $cData->details = request('details');
        $cData->openinfos = request('openinfos');
        $cData->openinfostitle = request('openinfostitle');
        $cData->urunfoto = request('urunfoto');
        $cData->urunrenk = request('urunrenk');
