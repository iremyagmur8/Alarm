...
Route::get('solaris/productimages',[ProductimagesController::class,'index'])->middleware('auth');
Route::get('solaris/add/productimages',[ProductimagesController::class,'create'])->middleware('auth');
Route::post('solaris/addproductimages',[ProductimagesController::class,'store'])->middleware('auth');
Route::get('solaris/productimages/edit/{id}',[ProductimagesController::class,'edit'])->middleware('auth');
