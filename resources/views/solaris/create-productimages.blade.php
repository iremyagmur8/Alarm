...
@section('modulecontent')
    ...
    <div class="portlet-box">
        <div class="portlet-header flex-row flex d-flex align-items-center">
            <a href="/solaris/add/productimages" class="btn btn-rounded btn-primary btn-sm m-r-5">Yeni Ekle</a>
            <a href="/solaris/productimages" class="btn btn-rounded btn-danger btn-sm  m-r-5">Tüm Ürünler</a>
        </div>

        <form class="form-horizontal" method="POST" action="/solaris/addproductimages" id="formData" style="padding: 15px" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="leftside"
                           value="@if(!empty($cData->data)){{$cData->data->leftside}}@endif"
                           autofocus>
                </div>
                <div class="form-group col-md-3">
                    <label for="title">Top</label>
                    <input type="text" class="form-control" name="topside"
                           value="@if(!empty($cData->data)){{$cData->data->topside}}@endif"
                           autofocus>
                </div>
