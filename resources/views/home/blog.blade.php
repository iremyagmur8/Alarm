        ...
        <div class="container">
            <div class="col-md-12">
                <div class="title-area  mb-4">
                    <span>BLOG</span>
                    <p>Her gün değişen ihtiyaçlar doğrultusunda ürün yelpazemiz değişmekte ve genişlemektedir. Kullanım
                        amacına uygun ve doğru ürünü seçerken, uzmanlarımıza danışabilirsiniz.</p>
                </div>
            </div>
            <!-- end: Page title -->
            <!-- Blog -->
                    ...
                    <div class="post-item border ">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a href="/blog/{{str_slug($val->title,"-")}}/{{$val->id}}">
                                    <div class="img"
